<div id="modal-tambah-pemasukan-customer" class="hidden">
    <div
        ...
        <div
            ...
            <div class="_header w-full">
                <div class="_title flex items-center gap-2">
                    ...
                    <span class="text-[16px] font-bold">Tambah Pemasukan</span>
                </div>
                <div class="_close"></div>
            </div>
            <div class="_body w-full mt-4 flex-grow p-2 overflow-y-auto">
                <form id="form-tambah-pemasukan" action="{{ route('keuangan.tambah-penghasilan', ['id_user' => Crypt::encrypt(session('id_user'))]) }}"
                    ...
                    <div class="_input w-full">
                        ...
                        <input class="border w-full border-solid rounded-[10px] text-[14px] p-2"
                            placeholder="Masukkan sumber pemasukan" type="text" id="sumber_pemasukan_customer" name="sumber"
                            required>
                    </div>
                    <div class="_input w-full">
                        <label for="number_phone">Deskripsi</label>
                        <input class="border w-full border-solid rounded-[10px] text-[14px] p-2"
                            placeholder="Masukkan deskripsi pemasukan" type="text" id="deskripsi_pemasukan_customer" name="deskripsi"
                            required>
                    </div>
                    <div class="_input w-full">
                        <label for="password">Nominal</label>
                        <input class="border w-full border-solid rounded-[10px] text-[14px] p-2"
                            placeholder="Masukkan nominal pemasukan" type="number" id="nominal_pemasukan_customer" name="nominal"
                            required>
                    </div>
                </form>
            </div>
            ...
            <div class="_footer w-full p-2 flex gap-2">
                ...
                <button class="text-[14px] shadow-box-shadow-8 py-2 px-4 rounded-full"
                 id="cancel-tambah-pemasukan-web-customer">Cancel</button>
            </div>
        </div>
    </div>
</div>
