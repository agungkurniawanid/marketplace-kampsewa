            ...
            <form action="" method="POST" class="flex flex-col gap-4">
                ...
                <div class="_feild-password flex flex-col gap-2">
                    ...
                    <div class="_email w-full">
                        <input placeholder="ex: 354yctei4936" class="border focus:outline-[#5038ED] w-full border-solid rounded-[10px] text-[14px] p-2"
                            type="password" name="password" id="password">
                    </div>
                    <label for="confirm-password" class="text-[14px] font-medium">Konfirmasi Password:</label>
                    <div class="_email w-full">
                        <input placeholder="same ex" class="border focus:outline-[#5038ED] w-full border-solid rounded-[10px] text-[14px] p-2"
                            type="password" name="confirm-password" id="confirm-password">
                    </div>
                </div>
                <div class="_button-submit w-full">
                    <button type="submit"
                        class="w-full p-2 bg-gradient-to-bl rounded-[10px] from-[#B381F4] to-[#5038ED] text-white text-[14px] font-medium">Ubah Password</button>
                </div>
