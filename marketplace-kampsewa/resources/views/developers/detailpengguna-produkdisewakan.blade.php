                ...
                <div class="_checkall-delete-filter w-full flex gap-4 items-center">
                    <div class="_checkall items-center flex gap-2">
                        ...
                        <div class="_delete-all">
                            <a href="" class="text-[14px] py-2 bg-[#FEF2F2] px-4 rounded-[7px] text-[#EF4444] delete-all-button">Hapus</a>
                        </div>
                    </div>
                    ...
                    <div class="_filter-category">
                        <div class="flex gap-2 items-center">
                            ...
                            <select class="border border-[#E5E7EB] rounded-[7px] px-4 py-2 text-[14px] font-medium"
                                ...
                                <option value="Semua Barang" {{ request('filter_category') == 'Semua Barang' ? 'selected' : '' }}>Semua Barang</option>
                                @foreach ($get_kategori as $kategori)
                                    <option value="{{ $kategori }}" {{ request('filter_category') == $kategori ? 'selected' : '' }}>{{ $kategori }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="w-full px-4 py-2 rounded-full shadow-box-shadow-36 flex items-center">
                            <div class="_input w-full">
                                <input type="text" class="w-full focus:outline-none text-[14px] font-medium"
                                    placeholder="Cari Barang" name="cari_barang" autofocus="true" value="{{ $cari_barang }}" autocomplete="on">
                            </div>
            ...
            @foreach ($get_data_produk as $item)
                <div
                    ...
                    <div class="_body p-2">
                        ...
                        <p class="mt-1 text-[14px]"><b>Rp. {{ number_format($item->harga_sewa_terkecil, 0, ',', '.') }}</b>/Hari</p>
                    </div>
